<div>
    <div class="mb-4">
        <x-input label="Company Name" id="name" class="block mt-1 w-full" type="text" name="name"
            placeholder="Enter Company Name" required wire:model="state.name" />
    </div>

    <div class="grid grid-cols-2 gap-4">

        <div class="mb-4">
            <x-textarea type="text" wire:model="state.mailing_address" label="Mailing address" name="mailing_address"
                placeholder="Enter Mailing address" required />

        </div>

        <div class="mb-4">
            <x-textarea label="General Details Of Service / Goods" id="details_of_service_goods"
                class="block mt-1 w-full" type="text" name="details_of_service_goods" required
                wire:model="state.details_of_service_goods" />
        </div>
