        ...
        <div class="grid grid-cols-4 gap-4">
            <div class="">
                <div class="shadow-md p-2 mb-4 rounded">
                    ...
                    <img src="{{asset('assets/img/profile')}}/{{$passport_picture}}" class="max-w-full max-h-[150px] text-center" alt="">
                    @else
                    <img src="{{asset('assets/img/profile/default.png')}}" class="max-w-full max-h-[150px] text-center" alt="default profile">
                    @endif
                </div>
                <!-- <div class="mb-4">
                    <x-input label="Passport Picture" type="file" wire:model.defer="newimage" />
                </div> -->
            </div>
            <div class="col-span-3">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <x-input label="Email" type="text" required wire:model.defer="email" disabled />

                    <x-input label="Position/Title" id="position" type="text" placeholder="Position or Title" required wire:model.defer="position" />
                    ...
                    <x-inputs.maskable label="ID Number (Ghana Card Only)" mask="AAA-#########-#" placeholder="GHA-000000000-0" required wire:model.defer="id_number" />
